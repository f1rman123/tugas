          ...
          <div class="container">
            <div class="row">
                <div class="col text-center">
                    <h4 class="H4">PRODUK TERBARU</h4>
                </div>
            </div>


        <!-- CARD -->
        <div class="container row mt-2" id="prodak">
            <?php 
                foreach($arrBarang as $x){
                  $barangurl = "assets/img/obat.png";
                  if($x['nama'] == 'Betadine 5mL'){
                    $barangurl = "assets/img/betadine.jpg";
                  }
                  if($x['nama'] == 'Betadine 10mL'){
                    $barangurl = "assets/img/betadine.jpg";
                  }
                  if($x['nama'] == 'Betadine 7mL'){
                    $barangurl = "assets/img/betadine.jpg";
                  }
                  if($x['nama'] == 'Dettol 7mL'){
                    $barangurl = "assets/img/dettol.jpg";
                  }
                  if($x['nama'] == 'Dettol 5mL'){
                    $barangurl = "assets/img/dettol.jpg";
                  }
                  if($x['nama'] == 'Dettol 10mL'){
                    $barangurl = "assets/img/dettol.jpg";
                  }
            ?>
            <div class="col-4 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <a href="home.php?buyProduk=<?php echo $x['produk_id']?>" class="btn btn-danger ">Rp <?php echo number_format($x['harga']);?></a>
                    </div>
                  </div>
            </div>
            <?php }?>
