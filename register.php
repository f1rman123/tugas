...
<html lang="en">
    ...
    <body>
        <div class="wrapper fadeInDown">
            <div id="formContent">
                <!-- Tabs Titles -->
                <button class="fadeIn second button form-control" onclick="location.href = 'home.php'">Go to home</button>
                ...
                <form>
                    ...
                    <input type="text" id="confirmPassword" class="fadeIn third" name="confirmPassword" placeholder="Confirm Password">
